...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { game_id: @slot.game_id, player_id: @slot.player_id, price: @slot.price } }, as: :json
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { game_id: @slot.game_id, player_id: @slot.player_id, price: @slot.price } }, as: :json
    assert_response 200
  end
