...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { address: @field.address, img_url: @field.img_url, size: @field.size } }, as: :json
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { address: @field.address, img_url: @field.img_url, size: @field.size } }, as: :json
    assert_response 200
  end
